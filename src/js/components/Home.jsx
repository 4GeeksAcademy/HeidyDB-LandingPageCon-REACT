	...
	return (
		...
		<div>
		  ...
		  <div className="text-center">
			...
			<Card img = "https://floweraura-blog-img.s3.ap-south-1.amazonaws.com/christmas-2023/secret-santa-ideas/Polaroid-Camera-D.jpg" title ="Viaja y captura el momento" description ="Siempre ten un viaje en mente. Esto es buena señal de que aun te sientes joven. Toma evidencia grafica siempre que puedas "/>   
		  </div>
