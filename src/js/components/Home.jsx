...
const Home = () => {
	...
	return (
		<>
		<div className="text-center dropdown-moviles">
			<Navbar />	
...
<div >ahora en 4 columnas</div>
		...
		<div className="text-center"> 
			...
			<CardWellcome />	
					...
					<div className="row row-cols-sm-6  row-cols-lg-4 gx-4"> 
...
export default Home;
//row row-cols-sm-6  row-cols-lg-4 gx-4
